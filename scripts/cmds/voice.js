this.config = {
	...
	cooldowns: 5,
	role: 0,
	shortDescription: "ข้อความเป็นคำพูด ",
	longDescription: "แปลข้อความเป็นเสียง",
	category: "media",
	envGlobal: {
...
module.exports = {
	...
	start: async function ({ api, args, message, event, download, globalGoat }) {
		...
		if (!content) return api.sendMessage("กรุณากรอกข้อความหรือตอบกลับข้อความ!", event.threadID, event.messageID);
